...
\input{grafove-algoritmy}
\section{Algebraické a aritmetické algoritmy}
\input{ciselne-algoritmy}
\section{Teorie mnohostěnů}
\input{mnohosteny-a-lp}
\input{problem-obchodniho-cestujiciho}
\input{specialni-matice}
\section{Celočíselnost}
\input{celociselnost-lp}
\section{Párování a toky v sítích}
\input{teorie-matroidu}
\section{Elipsoidová metoda}
\input{elipsoidova-metoda}
